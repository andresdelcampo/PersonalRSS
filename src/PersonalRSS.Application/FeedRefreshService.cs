        ...
        try
        {
            ...
            for (var index = 0; index < candidates.Count; index++)
            {
                ...
                articles.Add(new Article
                {
                    ...
                    LocalAutomaticScore = automatic,
                    LocalAutomaticScoreReason = score.Reason,
                    LocalAutomaticConfidence = Math.Clamp(score.Confidence, 0, 1),
                    LocalConfidenceReason = score.ConfidenceReason,
